...
if (typeof HTMLElement!="undefined" && ! HTMLElement.prototype.insertAdjacentElement) {
  ...
  FarsiType.KeyObject = function(z,x) {
	  ...
	  ChangeLang = function(e, ze) {
		  console.log('called changeLang function');
		  if(ze)
			  z = ze;
  
		  if (FarsiType.Type) {
			  console.log('it is persian language');
			  if (z.farsi) {
				  z.farsi = false;
				  if (FarsiType.ShowChangeLangButton == 1) { 
					  z.bottelm.value = "EN";
	  ...
	  Convert = function(e) {
		  ...
		  if (FarsiType.Type) {
			  console.log('it is called FarsiType.Type');
			  if (
	  ...
	  if (FarsiType.ShowChangeLangButton == 1) { 
		  console.log('FarsiType.ShowChangeLangButton == 1');
  ...
  console.log('it is loaded completely');